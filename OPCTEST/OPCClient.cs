    ...
    public class OPCClient
    {
        ...
        void KepGroup_DataChange(int TransactionID, int NumItems, ref Array ClientHandles, ref Array ItemValues, ref Array Qualities, ref Array TimeStamps)
        {
           ...
           /* for (int i = 1; i <= NumItems; i++)
            {
                //Console.WriteLine("************** " + ClientHandles.GetValue(i).ToString() + " **************");
                //Console.WriteLine("************** " + Qualities.GetValue(i).ToString() + " **************");
                //Console.WriteLine("************** " + TimeStamps.GetValue(i).ToString() + " **************");
                //int index = (int)ClientHandles.GetValue(i);
                //Console.WriteLine($"lKepItem:{ lKepItem[index].ItemID},{lKepItem[index].Value},{lKepItem[index].TimeStamp},{lKepItem[index].Quality}");
