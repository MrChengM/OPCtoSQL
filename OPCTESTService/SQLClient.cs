...
namespace SqlClientLib
{
    public class SQLClient
    {
        ...
        public SQLClient( string slogfilepath)
        {
        ...
        public bool ConnectSql()
        {
            ...
            catch(Exception e)
            {
                ...
                LogFunction.WriteLog(slogFilePath, $"Error:Open Sql Server Fail\"{ e.Message}\"");
        ...
        public bool sqlExecuteNonQuery(string sQueryString,out int iUpdateRows, CommandType comdtype)
        {
            ...
            catch(Exception e)
            {
                ...
                LogFunction.WriteLog(slogFilePath, $"Error:Execute Query Sql Fail\"{ e.Message}\"");
                //sqlcnt.Close();
                iUpdateRows = 0;
                return false;
        ...
        public bool sqlBulkCopyData(string sTableName,DataTable dt)
        {
            ...
            catch(Exception e)
            {
                ...
                LogFunction.WriteLog(slogFilePath, $"Error:Bulk Copy Data To Sql Fail\"{e.Message}\"");
                return false;
            }
